              ...
              <section className="rounded-xl p-6 shadow-sm bg-white" style={{ border: `1px solid ${C.beige}` }}>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    {errors.starting_price && <p className="text-xs mt-1 text-red-500">{errors.starting_price}</p>}
                  </div>
                  <div>
                    ...
                    {errors.reserve_price && <p className="text-xs mt-1 text-red-500">{errors.reserve_price}</p>}
                  </div>
                  <div>
                    ...
                    {errors.buy_now_price && <p className="text-xs mt-1 text-red-500">{errors.buy_now_price}</p>}
                  </div>
                  <div className="grid grid-cols-2 gap-4 pt-2">
                    <div>
                      ...
                      {errors.start_time && <p className="text-xs mt-1 text-red-500">{errors.start_time}</p>}
                    </div>
                    <div>
                      ...
                      {errors.end_time && <p className="text-xs mt-1 text-red-500">{errors.end_time}</p>}
                    </div>
                  </div>
                </div>
              </section>
              ...
              <section className="rounded-xl p-6 shadow-sm bg-white flex-1 flex flex-col" style={{ border: `1px solid ${C.beige}` }}>
                ...
                {campaignsLoading ? (
                  ...
                  <>
                    ...
                    {errors.campaign_id && <p className="text-xs mt-2 text-red-500">{errors.campaign_id}</p>}
                  </>
                )}
              </section>
            </div>
