...
-- Demo completed payment and receipt are generated automatically through the full flow.
-- To test receipts: admin force-close → bidder pay → donor ship → bidder confirm delivery.
