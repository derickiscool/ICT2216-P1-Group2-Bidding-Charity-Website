...
-- SFR03 verified email change (OWASP no-MFA dual confirmation). One pending change
-- per user; both the old and new address must confirm their OTP before it applies.
CREATE TABLE IF NOT EXISTS email_change_requests (
  user_id BIGINT PRIMARY KEY REFERENCES users(id) ON DELETE CASCADE,
  new_email TEXT NOT NULL,
  old_email TEXT NOT NULL,
  new_email_otp_hash TEXT NOT NULL,
