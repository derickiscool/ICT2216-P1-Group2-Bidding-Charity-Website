...
CREATE TABLE IF NOT EXISTS pending_registrations (
  ...
  created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  CONSTRAINT pending_registrations_roles_valid CHECK (roles <@ ARRAY['bidder', 'donor', 'charity']::TEXT[])
);

CREATE INDEX IF NOT EXISTS pending_registrations_expires_idx ON pending_registrations (expires_at);
DELETE FROM pending_registrations
  WHERE NOT (roles <@ ARRAY['bidder', 'donor', 'charity']::TEXT[]);
ALTER TABLE pending_registrations DROP CONSTRAINT IF EXISTS pending_registrations_roles_valid;
...
ALTER TABLE payments ADD COLUMN IF NOT EXISTS amount_encrypted TEXT;
ALTER TABLE payments ADD COLUMN IF NOT EXISTS payment_ref_encrypted TEXT;
...
ALTER TABLE receipts ADD COLUMN IF NOT EXISTS amount_encrypted TEXT;
